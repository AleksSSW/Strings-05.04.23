...
int main() {
	...
	/*std::cout << "задача 1. Введите строку:\n";
	std::string str1;
	std::getline(std::cin, str1);
	std::cout << spaces_str(str1) << "\n\n";*/
	//Задача 2. Спам из презентации
	/*std::cout << "Задача 2.\n Введите строку:\n";
	std::string str2;
	...
	//Задача 3.Вывод протокола, доменного имени, пути к странице
	std::cout << "Задача 3.\n Адрес:";
...
std::string spaces_str(std::string str) {
	std::string result; //просто пустая строка дополнительно
